...
// Settings page — Backup tab (Se1e7a6).
const (
	MsgSettingsTabBackup MessageID = "page.settings.tab.backup"

	// Backup retention section
	MsgSettingsBackupTitle        MessageID = "page.settings.backup.title"
	MsgSettingsBackupSub          MessageID = "page.settings.backup.sub"
	MsgSettingsBackupScheduleTitle MessageID = "page.settings.backup.schedule.title"
	MsgSettingsBackupScheduleAdd  MessageID = "page.settings.backup.schedule.add_btn"
	MsgSettingsBackupScheduleEmpty MessageID = "page.settings.backup.schedule.empty"
	MsgSettingsBackupRetHourly    MessageID = "page.backup.retention.hourly"
	MsgSettingsBackupRetDaily     MessageID = "page.backup.retention.daily"
	MsgSettingsBackupRetMonthly   MessageID = "page.backup.retention.monthly"
	MsgSettingsBackupColName      MessageID = "page.settings.backup.col.name"
	MsgSettingsBackupColCron      MessageID = "page.settings.backup.col.cron"
	MsgSettingsBackupColDatasets  MessageID = "page.settings.backup.col.datasets"
	MsgSettingsBackupColRetention MessageID = "page.settings.backup.col.retention"
	MsgSettingsBackupColActions   MessageID = "page.settings.backup.col.actions"
	MsgSettingsBackupDeleteBtn    MessageID = "page.settings.backup.delete_btn"
	MsgSettingsBackupEditBtn      MessageID = "page.settings.backup.edit_btn"
	MsgSettingsBackupFormName     MessageID = "page.settings.backup.form.name"
	MsgSettingsBackupFormCron     MessageID = "page.settings.backup.form.cron"
	MsgSettingsBackupFormDatasets MessageID = "page.settings.backup.form.datasets"
	MsgSettingsBackupFormHourly   MessageID = "page.settings.backup.form.hourly"
	MsgSettingsBackupFormDaily    MessageID = "page.settings.backup.form.daily"
	MsgSettingsBackupFormMonthly  MessageID = "page.settings.backup.form.monthly"
	MsgSettingsBackupFormSave     MessageID = "page.settings.backup.form.save"
	MsgSettingsBackupFormCancel   MessageID = "page.settings.backup.form.cancel"
	MsgSettingsBackupDelConfirm   MessageID = "page.settings.backup.delete.confirm"

	// Backend (offsite) section
	MsgSettingsBackendTitle      MessageID = "page.settings.backend.title"
	MsgSettingsBackendSub        MessageID = "page.settings.backend.sub"
	MsgSettingsBackendAddBtn     MessageID = "page.settings.backend.add_btn"
	MsgSettingsBackendEmpty      MessageID = "page.settings.backend.empty"
	MsgSettingsBackendColName    MessageID = "page.settings.backend.col.name"
	MsgSettingsBackendColKind    MessageID = "page.settings.backend.col.kind"
	MsgSettingsBackendColStatus  MessageID = "page.settings.backend.col.status"
	MsgSettingsBackendEditBtn    MessageID = "page.settings.backend.edit_btn"
	MsgSettingsBackendDeleteBtn  MessageID = "page.settings.backend.delete_btn"
	MsgSettingsBackendDelConfirm MessageID = "page.settings.backend.delete.confirm"
	MsgSettingsBackendFormName   MessageID = "page.settings.backend.form.name"
	MsgSettingsBackendFormKind   MessageID = "page.settings.backend.form.kind"
	MsgSettingsBackendFormHost   MessageID = "page.settings.backend.form.host"
	MsgSettingsBackendFormRepo   MessageID = "page.settings.backend.form.repo"
	MsgSettingsBackendFormRemote MessageID = "page.settings.backend.form.remote"
	MsgSettingsBackendFormToken  MessageID = "page.settings.backend.form.token"
	MsgSettingsBackendFormSave   MessageID = "page.settings.backend.form.save"
	MsgSettingsBackendFormCancel MessageID = "page.settings.backend.form.cancel"
	MsgSettingsBackendErrSave    MessageID = "page.settings.backend.err.save"
	MsgSettingsBackendErrDelete  MessageID = "page.settings.backend.err.delete"
	MsgSettingsBackupErrSave     MessageID = "page.settings.backup.err.save"
	MsgSettingsBackupErrDelete   MessageID = "page.settings.backup.err.delete"

	// System upgrade
	MsgSettingsUpgradeTitle       MessageID = "page.settings.upgrade.title"
	MsgSettingsUpgradeSub         MessageID = "page.settings.upgrade.sub"
	MsgSettingsUpgradeBtn         MessageID = "page.settings.upgrade.btn"
	MsgSettingsUpgradeConfirm     MessageID = "page.settings.upgrade.confirm"
	MsgSettingsUpgradeRunning     MessageID = "page.settings.upgrade.running"
	MsgSettingsUpgradeDone        MessageID = "page.settings.upgrade.done"
